...
<style>
  ...
  .instute-card{
    height: 100px ; width: 390px; margin: 6px; border: 1px solid #D2D6DF; border-radius: 5px;
  }
</style>
...
<div class="row">
        ...
        {{-- <div style="height: 100px ; width: 390px; margin: 6px; border: 1px solid #D2D6DF; border-radius: 5px;">
            <div class="p-3 d-flex justify-content-between">
                <img src="{{ asset('user/img/colleg_logo (1).jpg') }}" alt="">
                <div>
                    <p><a href="#">HAEC university</a> <br>
