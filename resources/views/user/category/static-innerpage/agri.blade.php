...
<style>
   ...
   span{
    ...
    <div>
        <h3 class="text-center py-2"> <img style="height: 40px" src="{{ asset("user/img/business-management-.svg") }}" alt="">: Agri-food</h3>
    </div>
            ...
            <div class="col-3 p-4 cat-sidebar d-fluid my-3 ">
                ...
                <div class="nav-item dropdown my-3">
                    ...
                    <select id="bechelor" name="bechelor">
                      <option value="" selected><a class="dropdown-item" href="#">Business & Management</a></option>
