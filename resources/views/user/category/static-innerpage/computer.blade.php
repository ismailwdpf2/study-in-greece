...
@section('usercontent')
    ...
    <div>
        <h3 class="text-center py-2"> <img style="height: 40px" src="{{ asset('user/img/business-management-.svg') }}"
                alt="">: Computer Science & IT</h3>
    </div>
        ...
        <div class=" row">
            <div class="col-3 p-4 cat-sidebar d-fluid my-3 ">
                ...
                <div class="nav-item dropdown my-3">
                    ...
                    <select id="bechelor" name="bechelor">
                        <option value="" selected><a class="dropdown-item" href="{{ route('cat_main') }}">Business &
                                Management</a></option>
            ...
            <div class="col-9">
                <div class=" cat-postarea my-3 p-3">
                    <div>
                        <h5>Computer Science & IT</h5>
                        <span><i class="fa-solid fa-location-dot" style="color: #2078DB;"></i> Athens, Thessaloniki</span>
                        <span> <i class="fa-regular fa-calendar" style="color: #2078DB;"></i> February 2024, October
                            2024</span>
