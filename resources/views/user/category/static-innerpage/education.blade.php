...
@section('usercontent')
    ...
    <div>
        <h3 class="inner-tittle"><img style="height: 35px; margin-bottom:3px"
                src="{{ asset('user/img/business-management-.svg') }}" alt="">&nbsp;&nbsp;Bachelor: Education</h3>
    </div>
            ...
            <div class="cat-postbar">
                <div class="cat-postarea my-3">
                    ...
                    <div class="d-flex p-2">
                        ...
                        <div class="descip"> Marketing is constantly developing. BA (Hons) Business (Marketing) helps
                            participants comprehend the
                ...
                <div class="cat-postarea my-3">
                    ...
                    <div class="d-flex p-2">
                        <img class="p-3" src="{{ asset('user/img/colleg_logo (1).jpg') }}" alt="">
                        <div class="descip">
                            Marketing is constantly developing. BA (Hons) Business (Marketing) helps participants comprehend
                            the
                            fundamental principles of marketing so as to be able to adjust and keep up with the constant
