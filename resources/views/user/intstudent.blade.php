...
<div class="international">
    ...
    <p>You have several options for studying in Greece.You can enrol in an English-taught degree programme or if you speak Greek,enrol in a Greek programme.On the ather hand,if you are not interested in a degree programme but want to do your traineeship in Greece,there are several options that are worth considering.You may also want to take a look at the map of Greece,to see where Athens and Thessaloniki, the two cities which gather the majority of higher education institutions of the country,are located.In our database you will find hundreds of study programmes, from short training seminars,e-learning education programmes,conferences, to full-fledged bachelor's and master's degree programmes,taught entirely in English, in Greek, or both languages.You can browse through the database to find the course or programme you are looking for.</p>
    <b><p>Do I need a visa?</p></b>
    <p>Foreigners from non-EU countries (with certain exceptions) wishing to study in Greece will need to acquire a student visa (type D) from a Greek consulate. There is a possibility of obtaining a student visa free of charge on request to a Greek consulate in the student’s country. Besides the standard documents (passport, photographs, etc.), foreign students will be required to submit an affidavit of sponsorship, proof of funds, medical and police clearance certificates, academic transcripts, language certificates and documents from the host institution in Greece. Applicants can expect to have an interview with consular staff.
        The Schengen Convention: Greece is a signatory to the Schengen Convention. If you have a visa issued by one of the Schengen countries, it is automatically valid for all other Schengen countries.</p>

        <u><p>For more information, see:</p></u>
<ul class="list-item">
